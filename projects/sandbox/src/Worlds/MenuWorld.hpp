...
namespace Worlds
{
	...
	public:
		MenuWorld()
		{
			/*ECS::GameProperties gp{ "Sandbox", SDL_WINDOW_FULLSCREEN, 800, 600};
			render_system = std::make_shared<ECS::RenderSystem>(gp);
			scott_entity = std::make_shared<ECS::Entity>();
			(*scott_entity).add_component<ECS::SpriteComponent>({ 10,10,"../assets/scott_standing.png" });
		...
		virtual void render() override
		{
			...
			PUK_CLIENT_INFO("Renderizando MenuWorld");
		}
	};
}